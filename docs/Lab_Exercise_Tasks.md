...
### Lab 5: รัน Backend และแก้ Configuration
...
### Lab 9: API 3 กรณีและ Log

- กรณีสำเร็จ: ค้นหาด้วยคำที่มีข้อมูล
- กรณี Validation: ส่ง `limit` ไม่ถูกต้องหลังทำ Lab 8
...
### Lab 10: ตรวจงานและหาบริการที่มีปัญหา
...
### Lab 11: Baseline และ Index

- รัน `01_create_schema.sql` และ `02_seed_data.sql`
- รัน Query ใน `03_lab11_before_index.sql` ด้วย `EXPLAIN (ANALYZE, BUFFERS)`
...
- ใช้ `04_lab12_after_index.sql` เป็นกรณีศึกษาเรื่อง Expression Index และ Partial Index
